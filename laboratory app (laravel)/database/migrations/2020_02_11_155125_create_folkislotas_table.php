...
class CreateFolkislotasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('folkislotas', function (Blueprint $table) {
            ...
            $table->decimal('folkislota')->nullable();
    ...
    {
        Schema::dropIfExists('folkislotas');
    }
}
