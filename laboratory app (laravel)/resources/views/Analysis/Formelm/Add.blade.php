...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('FormelmStore')}}" method="POST">
		@csrf
		

<h3>Определение количества форменных элементов мочи | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td width="15%"> 
        <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="leukocyte">
        </td>
        <td class="unit"> 
        </td>
    ...
    <tr>
        ...
        <td width="15%"> 
        <input type="number"  step="0.01" class="form-control input-sm" placeholder="Количество" name="erythrocyte">
        </td>
        <td class="unit"> 
        </td>
        <td>  1  * 10 <sup>6</sup>/L
  ...
  <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="cylinders">
      </td>
      <td class="unit"> 
      </td>
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Определение количества форменных элементов мочи">
