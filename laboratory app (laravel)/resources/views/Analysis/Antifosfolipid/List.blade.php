	...
	<form action="{{route('analisysList')}}" method="GET">
        ...
        <div class="row" style="margin-left: -15px;">
            ...
            <div class="col-md-4">
                ...
                <option value="{{$slug}}">Антифосфолипидный скрининг</option>   
                <option>--------------------------------------</option>  
        ...
        <div class="card">                  
                    <table class="table table-hover">
                          ...
                          {{$resultItem->patient_lastname}}   {{$resultItem->patient_name}}  {{$resultItem->patient_patronymic}} 
                            ...
                            <td>                                
                            <p style="line-height: 1.5;"> <a href="{{ route('AntifosfolipidShow', ['id'=>$resultItem->id]) }}">  {{$resultItem->analiseType}} </a></p> 
                            </td>
