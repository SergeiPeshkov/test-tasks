...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('AntifosfolipidStore')}}" method="POST">
		@csrf		
  <h3>Антифосфолипидный скрининг | Добавить</h3>
...
<table class="table table-hover analisis"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="lgg">
      </td>
      <td class="unit">
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="lgm">
      </td>
      <td class="unit">
      </td>
      <td><h6>< 10 отрицательный <br> >= 10 положительный </h6>
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Антифосфолипидный скрининг">
