...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('InfekciiStore')}}" method="POST">
		@csrf		
<h3>Инфекции (ВПГ, ЦМВ) | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
        <select class="form-control" name="vpg">
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Инфекции (ВПГ, ЦМВ)">
