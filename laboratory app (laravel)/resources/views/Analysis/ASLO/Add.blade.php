...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('ASLOStore')}}" method="POST">
		@csrf
		

<h3>Анализ на антистрептолизин-О | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <td width="15%"> 
    <input type="number" step="0.01" class="form-control input-sm" name="result" required>
    </td>
    <td class="unit">Е/л
    </td>
    <td> до 200 Е/л
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ на антистрептолизин-О">
