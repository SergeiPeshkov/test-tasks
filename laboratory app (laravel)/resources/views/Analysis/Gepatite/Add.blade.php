...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('GepatiteStore')}}" method="POST">
		@csrf		
<h3>Анализ крови на маркеры вирусных гепатитов | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text" class="form-control input-sm" placeholder="результат" name="hbsag">
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text" class="form-control input-sm" placeholder="результат" name="ab_hbcor">
      </td>
      <td class="unit"> Отрицательный
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text" class="form-control input-sm" placeholder="результат" name="ab_hbcor_lgm">
      </td>
      <td class="unit"> Отрицательный
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text"  class="form-control input-sm" placeholder="результат" name="hbeag">
      </td>
      <td class="unit"> Отрицательный
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text" class="form-control input-sm" placeholder="результат" name="ab_hbe">
      </td>
      <td class="unit"> Отрицательный
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text" class="form-control input-sm" placeholder="результат" name="ab_hdv">
      </td>
      <td class="unit">Отрицательный 
      </td>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text"  class="form-control input-sm" placeholder="результат" name="ab_hcv">
      </td>
      <td class="unit"> Отрицательный
      </td>
  ...
  <tr>
      ...
      <td width="15%"> 
      <input type="text" class="form-control input-sm" placeholder="результат" name="hcv">
      </td>
      <td class="unit"> Отрицательный
      </td>
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ крови на маркеры вирусных гепатитов">
