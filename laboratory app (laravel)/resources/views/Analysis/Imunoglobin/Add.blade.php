...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('ImunoglobinStore')}}" method="POST">
		@csrf		
<h3>Определение иммуноглобина | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="imE">
      </td>
      <td class="unit">МЕ/мл
      </td>
      <td>до 130 МЕ/мл
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="imG">
      </td>
      <td class="unit">г/л
      </td>
      <td>7-16 г/л
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="imA">
      </td>
      <td class="unit">г/л
      </td>
      <td>0,7-4,0 г/л
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="imM">
      </td>
      <td class="unit">г/л
      </td>
      <td>0,4-2,3 г/л
  ...
  <tr> 
    ...
    <td width="15%"> 
      <input type="text"  class="form-control" name="laborant" required>  
       ...
       <br>
       <input type="hidden" name="analiseType" value="Определение иммуноглобина">
