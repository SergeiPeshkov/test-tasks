...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('KortizolPDF', ['id'=>$result->id])}}" method="POST">
		@csrf
		

<h3>Анализ крови на гормоны надпочечников |
...
<div class="input-group form-row">         
  ...
  @if($result->kortizol)
    <tr>
      ...
      <td width="15%">    
      <p class="fieldOutputAnalis">{{$result->kortizol}}</p> 
      </td>
