...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('KortizolStore')}}" method="POST">
		@csrf		
<h3>Анализ крови на гормоны надпочечников | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="kortizol" required>
      </td>
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ крови на гормоны надпочечников">
