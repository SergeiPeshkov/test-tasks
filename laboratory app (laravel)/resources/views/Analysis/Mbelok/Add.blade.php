...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('MbelokStore')}}" method="POST">
		@csrf
		

<h3>Анализ суточной мочи на белок | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td width="15%"> 
        <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="gr">
        </td>
        <td class="unit"> 
        </td>
        <td> 
  ...
  <tr>
    ...
    <td width="15%"> 
    <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="count">
    </td>
    <td class="unit"> 
    </td>
    <td> 
  ...
  <tr>
    ...
    <td width="15%"> 
    <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="specific_weight">
    </td>
    <td class="unit"> 
    </td>
    <td> 
  ...
  <tr>
    ...
    <td width="15%"> 
    <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="protein">
    </td>
    <td class="unit"> 
    </td>
    <td> 
  ...
  <tr>
    ...
    <td width="15%"> 
    <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="daily_protein">
    </td>
    <td class="unit"> 
    </td>
    <td> 
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ суточной мочи на белок">
