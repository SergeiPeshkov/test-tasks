	...
	<form action="{{route('analisysList')}}" method="GET">
        ...
        <div class="row" style="margin-left: -15px;">
            ...
            <div class="col-md-4">
                ...
                <option value="{{$slug}}">Аналик крови на половые гормоны и онкомаркеры</option>   
                <option>--------------------------------------</option>  
        ...
        <div class="card">                  
                    <table class="table table-hover">
                          ...
                          <tbody>                
                            ...
                            <td>                                
                            <p style="line-height: 1.5;"> <a href="{{ route('SgomShow', ['id'=>$resultItem->id]) }}">  {{$resultItem->analiseType}} </a></p> 
                            </td>
