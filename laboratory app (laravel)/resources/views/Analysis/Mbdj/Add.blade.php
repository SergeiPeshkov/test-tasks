...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('MbdjStore')}}" method="POST">
		@csrf
		

<h3>Анализ мочи Бенс Джонса | Добавить</h3>
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ мочи Бенс Джонса">
