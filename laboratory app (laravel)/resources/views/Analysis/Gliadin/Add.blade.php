...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('GliadinStore')}}" method="POST">
		@csrf		
<h3>Анализ крови на антитела к глиадину | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="number" step="0.01" class="form-control input-sm" placeholder="количество" name="anti_gliadin" required>
      </td>
      <td class="unit">Ед/мл
      </td>
      <td>до 12 Ед/мл
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ крови на антитела к глиадину">
