...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('GlukozaStore')}}" method="POST">
		@csrf
		

<h3>Анализ крови на содержание глюкозы | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <td width="15%"> 
    <input type="number" step="0.01" class="form-control input-sm" placeholder="Количество" name="glukoza" required>
    </td>
...
-->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Анализ крови на содержание глюкозы">
