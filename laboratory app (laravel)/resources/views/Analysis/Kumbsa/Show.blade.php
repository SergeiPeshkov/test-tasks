...
<div class="container-new-contract">
	...
	<form class="form-new-contract" action="{{route('KumbsaPDF', ['id'=>$result->id])}}" method="POST">
		@csrf
		

<h3>Исследование крови на пробу Кумбса |
...
<table class="table table-hover table-bordered table-sm analisisResult">
  ...
  <tbody class="analisis">
    ...
    <tr>
      ...
      <p class="fieldOutputAnalis">{{$result->proba}}</p>
    </td>
      </td>
      <td class="unit">
      </td>
