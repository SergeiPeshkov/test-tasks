...
<div class="container-new-contract">
	<form class="form-new-contract" action="{{route('KumbsaStore')}}" method="POST">
		@csrf		
<h3>Исследование крови на пробу Кумбса | Добавить</h3>
...
<table class="table table-hover analisis">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="15%"> 
      <input type="text" step="0.01" class="form-control input-sm" name="proba" required>
      </td>
      <td class="unit">
      </td>
      <td>
...
<table class="table table-hover" width="60%" >
  ...
  -->
       ...
       <br>
       <input type="hidden" name="analiseType" value="Исследование крови на пробу Кумбса">
